...
namespace Recorder
{
    ...
    public class InputSettingsList// : IEnumerable<RecorderInputSetting> // TODO Find a way to fix this because it's not serializable
    {
        ...
        List<RecorderInputSetting> m_InputsSettings = new List<RecorderInputSetting>();

        public IEnumerable<RecorderInputSetting> inputSettings
        {
...
//        public void Rebuild()
//        {
//            var inputSettings = new List<RecorderInputSetting>();
//
...
//        }
        ...
        public void AddRange(IEnumerable<RecorderInputSetting> input)
        {
            m_InputsSettings.AddRange(input);
